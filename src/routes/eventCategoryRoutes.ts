...
import { createEventCategoryRoute, deleteEventCategoryRoute, getEventCategoryByIdRoute, listEventCategoryRoute, updateEventCategoryRoute } from "../controllers/eventCategoryController.js";
...
export async function eventCategoryRoutes(server:FastifyInstance) {
    ...
    server.put("/:id", updateEventCategoryRoute)
}